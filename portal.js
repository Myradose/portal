...
function initPortal() {
  ...
  // iOS defaults
  const IOS_REAL = { bloom: true, fakeBloom: false, haze: false, coreSize: 0.12, emberSize: 0.06, hazeIntensity: 1.3, bloomStrength: 0.45, bloomRadius: 0, bloomThreshold: 0.1 }
